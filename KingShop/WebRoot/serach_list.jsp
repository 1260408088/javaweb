...
<body>
	...
	<div style="width: 380px; margin: 0 auto; margin-top: 50px;">
		<ul class="pagination" style="text-align: center; margin-top: 10px;">
			...
			<c:if test="${pagebean.currentPage!=1 }">
				<li >	
					<a href="${pageContext.request.contextPath}/SerachPageServlet?goodsname=${goodsname}&currentPage=${pagebean.currentPage-1 }" aria-label="Previous">
						<span aria-hidden="true">&laquo;</span>
					</a>
				</li>
			</c:if>
			...
			<c:forEach begin="1" end="${pagebean.totalPager }" var="pro">
				...
				<c:if test="${pagebean.currentPage!=pro}">
					<li><a href="${pageContext.request.contextPath}/SerachPageServlet?goodsname=${goodsname}&currentPage=${pro }">${pro }</a></li>
				</c:if>
			</c:forEach>
			<!--  下一頁-->
			...
			<c:if test="${pagebean.currentPage!=pagebean.totalPager }">
				<li >	
					<a href="${pageContext.request.contextPath}/SerachPageServlet?goodsname=${goodsname}&currentPage=${pagebean.currentPage+1 }" aria-label="Next">
						<span aria-hidden="true">&raquo;</span>
					</a>
				</li>
			</c:if>
		...
		<div style="overflow: hidden;">
			...
			<ul style="list-style: none;">
				<c:forEach items="${historyProductList }" var="histortPro">
					...
					src="${histortPro.pimage }" width="130px" height="130px" />
				</li>			
				</c:forEach>
			</ul>
