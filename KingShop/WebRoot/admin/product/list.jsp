							...
							<c:forEach items="${allProduct }" var="product" varStatus="vs">
								...
								onmouseout="this.style.backgroundColor = '#F5FAFE';">
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/productDateback?pid=${product.pid}">
											<img
											src="${pageContext.request.contextPath}/images/i_edit.gif"
											border="0" style="CURSOR: hand">
									</a></td>
	
									<td align="center" style="HEIGHT: 22px"><a href="javascript:void(0);" onclick="deletepro('${product.pid }')"> <img
