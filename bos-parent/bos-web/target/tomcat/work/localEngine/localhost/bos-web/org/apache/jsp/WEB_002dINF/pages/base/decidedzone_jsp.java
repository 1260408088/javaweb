...
public final class decidedzone_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t//弹出提示\r\n");
      out.write("\t\t\t$.messager.alert(\"提示信息\",\"请选择一个定区操作！\",\"warning\");\r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\t//选中了一个定区\r\n");
      ...
      out.write("\t\t\t//发送ajax请求，请求定区Action，在定区Action中通过crm代理对象完成对于crm服务远程调用获取客户数据\r\n");
      out.write("\t\t\tvar url_1 = \"decidedzoneAction_findListNotAssociation.action\";\r\n");
      out.write("\t\t\t$.post(url_1,function(data){\r\n");
      out.write("\t\t\t\t//遍历json数组\r\n");
      out.write("\t\t\t\tfor(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\tvar id = data[i].id;\r\n");
      out.write("\t\t\t\t\tvar name = data[i].name;\r\n");
      out.write("\t\t\t\t\tvar telephone = data[i].telephone;\r\n");
      out.write("\t\t\t\t\tname = name + \"(\" + telephone + \")\";\r\n");
      out.write("\t\t\t\t\t$(\"#noassociationSelect\").append(\"<option value='\"+id+\"'>\"+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t\t\r\n");
      out.write("\t\t\t//发送ajax请求，请求定区Action，在定区Action中通过crm代理对象完成对于crm服务远程调用获取客户数据\r\n");
      out.write("\t\t\tvar url_2 = \"decidedzoneAction_findListHasAssociation.action\";\r\n");
      out.write("\t\t\tvar decidedzoneId = rows[0].id;\r\n");
      out.write("\t\t\t$.post(url_2,{\"id\":decidedzoneId},function(data){\r\n");
      out.write("\t\t\t\t//遍历json数组\r\n");
      out.write("\t\t\t\tfor(var i=0;i<data.length;i++){\r\n");
      out.write("\t\t\t\t\tvar id = data[i].id;\r\n");
      out.write("\t\t\t\t\tvar name = data[i].name;\r\n");
      out.write("\t\t\t\t\tvar telephone = data[i].telephone;\r\n");
      out.write("\t\t\t\t\tname = name + \"(\" + telephone + \")\";\r\n");
      out.write("\t\t\t\t\t$(\"#associationSelect\").append(\"<option value='\"+id+\"'>\"+name+\"</option>\");\r\n");
      out.write("\t\t\t\t}\r\n");
      out.write("\t\t\t});\r\n");
      out.write("\t\t}\r\n");
      out.write("\t}\r\n");
      ...
      out.write("\t\t\turl : \"decidedzoneAction_pageQuery.action\",\r\n");
      ...
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("\tfunction doDblClickRow(index,data){\r\n");
      out.write("\t\t//将页面中table变为datagrid样式\r\n");
      out.write("\t\t$('#association_subarea').datagrid( {\r\n");
      out.write("\t\t\tfit : true,\r\n");
      out.write("\t\t\tborder : true,\r\n");
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"subareaAction_findListByDecidedzoneId.action?decidedzoneId=\"+data.id,\r\n");
      out.write("\t\t\tcolumns : [ [{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t});\r\n");
      out.write("\t\t\r\n");
      out.write("\t\t$('#association_customer').empty();\r\n");
      out.write("\t\t//创建展示客户数据的数据表格\r\n");
      out.write("\t\t$('#association_customer').datagrid( {\r\n");
      out.write("\t\t\tfit : true,\r\n");
      out.write("\t\t\tborder : true,\r\n");
      out.write("\t\t\trownumbers : true,\r\n");
      out.write("\t\t\tstriped : true,\r\n");
      out.write("\t\t\turl : \"decidedzoneAction_findListHasAssociation.action?id=\"+data.id,\r\n");
      out.write("\t\t\tcolumns : [[{\r\n");
      out.write("\t\t\t\tfield : 'id',\r\n");
      ...
      out.write("\t\t\t<form id=\"addDecidedzoneForm\" method=\"post\"\r\n");
      out.write("\t\t\t\taction=\"decidedzoneAction_add.action\">\r\n");
      ...
      out.write("    \t\t\t\t\t\t\turl:'staffAction_listajax.action'\" />  \r\n");
      out.write("\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t</tr>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\tdata-options=\"url:'subareaAction_listajax.action',fitColumns:true,singleSelect:false\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<thead>  \r\n");
      out.write("\t\t\t\t\t\t\t        <tr>  \r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t});\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\t//为关联客户按钮绑定事件\r\n");
      out.write("\t\t\t\t\t\t\t\t\t$(\"#associationBtn\").click(function(){\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar rows = $(\"#grid\").datagrid(\"getSelections\");\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvar id = rows[0].id;\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t//为隐藏域（存放定区id）赋值\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t$(\"input[name=id]\").val(id);\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t//提交表单之前，需要将右侧下拉框中所有的选项选中,为option添加一个selected属性\r\n");
