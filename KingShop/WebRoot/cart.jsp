...
<html>
	<head>
		...
		<script type="text/javascript">
			function removePro(pid){
				if(confirm("您是否要删除此商品")){
					location.href="${pageContext.request.contextPath }/RemoveProToCart?pid="+pid;
				}
			}
	...
	<c:if test="${!empty cart.caritems }">
			<div class="container">
						...
						<table class="table table-bordered">
							<tbody>
								...
								<c:forEach items="${cart.caritems }" var="entry">
									...
									<td>
										<a href="javascript:;" onclick="removePro('${entry.value.product.pid}')" class="delete">删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
				...
				<div style="margin-right:130px;">
					...
					<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
						...
						<a href="${pageContext.request.contextPath }/submitOredr">
		...
		<c:if test="${empty cart.caritems }">
			<div>
				...
				<a href="${pageContext.request.contextPath }">前往首页</a>
			</div>
		</c:if>
		<!-- 引入footer.jsp -->
