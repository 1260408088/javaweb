...
<HTML>
	<HEAD>
		...
		<script type="text/javascript">
			...
			/* $(function(){
				//在页面加载完毕后，异步查询分类信息
				$.post(
					"${pageContext.request.contextPath}/findallcategory", //要访问的servlet地址	
					 function(data){
					 	var content="";
	...
	<body>
		<!--  -->
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/UpdateProductServlet?productpid=${productpid}&upload=${product.pimage}" method="post" enctype="multipart/form-data">
			<input type="hidden" id="king" name="king" value="guo" />
