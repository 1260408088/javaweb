						...
						<tr
							...
							<c:forEach items="${namelist }" var="name" varStatus="vs">
								...
								<td style="CURSOR: hand; HEIGHT: 22px" align="center"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="17%">${name.cname }</td>
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/admin/category/edit.jsp?cid=${name.cid}&catename=${name.cname}">
											<img
									...
									<a href="${pageContext.request.contextPath}/deletecategory?cid=${name.cid}">
